            ...
            <div>
                ...
                <div className="row justify-content-around">
                    ...
                    <div className="col-md-2 d-flex flex-column justify-content-between question">
                        ...
                        <button type="button" className="btn btn-warning btn-block align-self-end" value="4" onClick={this.handleClick}>
                            Eat and Say Sorry
                        </button>
                    </div>
                    <div className="col-md-2 d-flex flex-column justify-content-between question">
                        <p>Leave the donut alone and let someone else eat it.</p>
                        <button type="button" className="btn btn-warning btn-block align-self-end" value="1" onClick={this.handleClick}>
                            Leave It
                        </button>
                    </div>
                    <div className="col-md-2 d-flex flex-column justify-content-between question">
                        <p>Eat the donut, but buy a box of donuts on the way into work tomorrow</p>
                        <button type="button" className="btn btn-warning btn-block align-self-end" value="2" onClick={this.handleClick}>
                            Buy Donuts
                        </button>
                    </div>
                    <div className="col-md-2 d-flex flex-column justify-content-between question">
                        ...
                        <button type="button" className="btn btn-warning btn-block align-self-end" value="5" onClick={this.handleClick}>
                            Create a Diversion
                        </button>
                    </div>
                </div>
